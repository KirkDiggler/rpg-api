...
//
//	mockgen -destination=internal/repositories/encounters/mock/mock_repository.go -package=encountermock github.com/KirkDiggler/rpg-api/internal/repositories/encounters Repository
//
