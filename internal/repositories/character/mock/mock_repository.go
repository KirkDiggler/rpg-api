...
func (m *MockRepository) GetAppearance(ctx context.Context, input character.GetAppearanceInput) (*character.GetAppearanceOutput, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAppearance", ctx, input)
	ret0, _ := ret[0].(*character.GetAppearanceOutput)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockRepository) SetAppearance(ctx context.Context, input character.SetAppearanceInput) (*character.SetAppearanceOutput, error) {
	m.ctrl.T.Helper()
