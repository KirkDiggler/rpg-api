...
func (s *BundleExtractionTestSuite) TestFinalizeDraft_ExtractsFighterMartialWeaponAndShieldBundle() {
	...
	s.setupExternalMocks(constants.RaceHuman, constants.ClassFighter, constants.BackgroundSoldier)
...
func (s *BundleExtractionTestSuite) setupExternalMocks(raceID constants.Race, classID constants.Class, backgroundID constants.Background) {
...
func (s *BundleExtractionTestSuite) TestFinalizeDraft_HandlesMultipleBundles() {
	...
	draft := &toolkitchar.DraftData{
		...
		BackgroundChoice: constants.BackgroundNoble,
		AbilityScoreChoice: shared.AbilityScores{
			constants.STR: 16,
			constants.DEX: 12,
			constants.CON: 15,
	...
	// Mock external data retrieval
	s.setupExternalMocks(constants.RaceDwarf, constants.ClassFighter, constants.BackgroundNoble)
...
func (s *BundleExtractionTestSuite) TestFinalizeDraft_MixedBundlesAndRegularItems() {
	...
	// Mock external data retrieval
	s.setupExternalMocks(constants.RaceElf, constants.ClassFighter, constants.BackgroundHermit)
