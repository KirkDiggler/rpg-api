...
require (
	github.com/KirkDiggler/rpg-api-protos/gen/go v0.0.0-20250715181229-e208df8e1b93
...
require (
	...
	github.com/fadedpez/dnd5e-api v0.0.0-20250713061616-46c0b6bf2b5b // indirect
