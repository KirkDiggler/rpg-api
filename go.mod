...
require (
	github.com/KirkDiggler/rpg-api-protos/gen/go v0.0.0-20260827130907-4d2ba6a8a1d9
...
require (
	...
	github.com/KirkDiggler/rpg-toolkit/rulebooks/dnd5e/resolution v0.24.4 // indirect
